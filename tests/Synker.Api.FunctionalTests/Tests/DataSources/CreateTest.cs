...
namespace Synker.Api.FunctionalTests.Tests.DataSources
{
    ...
    public class CreateTest
    {
        ...
        {
            var httpResponse = await _client.PostAsJsonAsync("/api/1.0/datasources", new CreateDataSourceCommand { UserId = 1, PlaylistDataSourceFormat = PlaylistDataSourceFormatEnum.M3u });
